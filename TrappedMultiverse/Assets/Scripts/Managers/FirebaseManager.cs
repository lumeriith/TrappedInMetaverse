...
public class FirebaseManager : ManagerBase<FirebaseManager>
{
    ...
    public Action<bool> onLoggedInChanged;
    ...
    private void AuthStateChanged(object sender, System.EventArgs eventArgs) {
        ...
        {
            isLoggedIn = true;
            onLoggedInChanged?.Invoke(true);
        }
        else if (auth.CurrentUser == null && isLoggedIn)
        {
            isLoggedIn = false;
            onLoggedInChanged?.Invoke(false);
        }
    }
    ...
    private readonly string[] RandomNames = @"alder
african rice
african violet
