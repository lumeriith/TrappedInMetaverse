...
public class FirstPersonAudio : MonoBehaviour
{
    ...
    public AudioClip[] landingSFXMario;

    [Header("Jump")]
    public Jump jump;
    public AudioSource jumpAudio;
    public AudioClip[] jumpSFX;
    public AudioClip[] jumpSFXMario;
    ...
    {
        PlayRandomClip(landingAudio, ModeManager.instance.mode == GameMode.Mario ? landingSFXMario : landingSFX);
    }

    private void PlayJumpAudio()
    {
        PlayRandomClip(jumpAudio, ModeManager.instance.mode == GameMode.Mario ? jumpSFXMario : jumpSFX);
    }
